...
def main():
    ...
    st.title("Pop from LyfeGym")
    st.info( "Hello! I am Popeye. I am here to answer any question you may have about the gym and our services. How may I help you today?")
